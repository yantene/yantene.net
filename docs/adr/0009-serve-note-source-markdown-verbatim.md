...
1. 素の Markdown をどこから引くか。正本は GitHub リポジトリにあり、D1 はメタデータ、
...
- **案 C: refresh 時に原文を R2 にも置き、そこから配信する** — `INoteContentCache` に
  ...
  - Pros: 0004 の役割分担 (正本は refresh 時のみ、配信は D1 + R2) を崩さない。
