...
| [0004](0004-github-as-content-source-of-truth.md)            | コンテンツの正本を GitHub に置き、D1 / R2 をキャッシュにする         | Deprecated → [0031](0031-artifacts-as-content-source-of-truth.md) |
...
| [0031](0031-artifacts-as-content-source-of-truth.md)         | コンテンツの正本を Cloudflare Artifacts に置き、REST API で読む      | Accepted                                                          |
