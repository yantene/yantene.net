...
- [x] 2. frontmatter パースライブラリの導入とパース関数の実装
- [x] 2.1 (P) frontmatter パース用ライブラリのインストール
...
- [x] 2.3 Markdown frontmatter パース関数の実装
...
- [x] 3. Notes 用オブジェクトストレージインタフェースと R2 実装
- [x] 3.1 (P) ドメイン層にオブジェクトストレージインタフェースを定義
...
- [x] 4. コマンドリポジトリの拡張
- [x] 4.1 (P) ドメインインタフェースに upsert と slug ベース削除を追加
...
- [x] 4.2 D1 実装に upsert と deleteBySlug を追加
...
- [x] 6. API エンドポイントの実装とルーティング統合
- [x] 6.1 POST /api/v1/notes/refresh ハンドラの実装
